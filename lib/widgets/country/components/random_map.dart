...
class RandomWorldMapGenerator extends StatefulWidget {
  const RandomWorldMapGenerator({super.key});

  @override
  RandomWorldMapGeneratorState createState() =>
      RandomWorldMapGeneratorState();
}

class RandomWorldMapGeneratorState extends State<RandomWorldMapGenerator> {
  List<Color> colors = [
